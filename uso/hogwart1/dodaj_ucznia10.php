<div style="margin-top: 8%; margin-bottom: 8%;">
    <form method="POST">
        <div class="mb-3">
            ...
            <input type="text" class="form-control mt-2" name="imieN6" required>
            <input type="text" class="form-control mt-2" name="imieN7" required>
            <input type="text" class="form-control mt-2" name="imieN8" required>
            <input type="text" class="form-control mt-2" name="imieN9" required>
            <input type="text" class="form-control mt-2" name="imieN10" required>
        </div>
        <div class="mb-3">
